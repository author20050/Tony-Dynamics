...
CREATE TABLE IF NOT EXISTS sports_bets (
  ...
  bet_type TEXT NOT NULL DEFAULT 'single' CHECK (bet_type IN ('single', 'acca')),
...
ALTER TABLE sports_bets ADD COLUMN IF NOT EXISTS bet_type TEXT NOT NULL DEFAULT 'single';
ALTER TABLE sports_bets DROP CONSTRAINT IF EXISTS sports_bets_bet_type_check;
ALTER TABLE sports_bets ADD CONSTRAINT sports_bets_bet_type_check CHECK (bet_type IN ('single', 'acca'));
